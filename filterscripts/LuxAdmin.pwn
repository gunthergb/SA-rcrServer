...
public OnPlayerDisconnect(playerid, reason)
{
    ...
    dUserSetINT(PlayerName(playerid)).("carsbombed",carsbombed[playerid]);
    dUserSetINT(PlayerName(playerid)).("terroristrank",terroristrank[playerid]);
	}
...
dcmd_CMD_REGISTER(playerid,params[])
{
    ...
    if (udb_Create(PlayerName2(playerid)))
	{
	    ...
	    dUserSetINT(PlayerName(playerid)).("terroristrank",0);
	    dUserSetINT(PlayerName(playerid)).("carsbombed",0);
