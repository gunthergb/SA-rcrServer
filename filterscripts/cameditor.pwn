...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd, "/switchpos", true) == 0)
	{
	    new	camerapos[256];
		camerapos = strtok(cmdtext, idx);
		if(!strlen(camerapos))
		{
			SendClientMessage(playerid, 0xFF0000AA, "/switchpos 1-18");
			return 1;
		}
		if(strcmp(camerapos,"1",true) == 0)
		{
			SetPlayerPos(playerid, 1539.7841, -1675.6234, 13.5493);
			SetPlayerFacingAngle(playerid, 90.0);
		}
		else if(strcmp(camerapos,"2",true) == 0)
		{
			SetPlayerPos(playerid, -1605.7126, 720.4283, 11.9981);
			SetPlayerFacingAngle(playerid, 0.0);
		}
		else if(strcmp(camerapos,"3",true) == 0)
		{
			SetPlayerPos(playerid, 2290.1448, 2421.4819, 10.8203);
			SetPlayerFacingAngle(playerid, 180.0);
		}
		else if(strcmp(camerapos,"4",true) == 0)
		{
   			SetPlayerPos(playerid, 683.0039, -2061.4797, 10.2929);
			SetPlayerFacingAngle(playerid, 90.0);
		}
		else if(strcmp(camerapos,"5",true) == 0)
		{
			SetPlayerPos(playerid, -2891.8352, 450.9204, 4.9472);
			SetPlayerFacingAngle(playerid, 0.0);
		}
		else if(strcmp(camerapos,"6",true) == 0)
		{
		    SetPlayerPos(playerid, 267.1800, 1897.1406, 33.8984);
		    SetPlayerFacingAngle(playerid, 0.0);
		}
		else if(strcmp(camerapos,"7",true) == 0)
		{
		    SetPlayerPos(playerid, 1903.4794, 965.0924, 10.8203);
			SetPlayerFacingAngle(playerid, 180);
		}
		else if(strcmp(camerapos,"8",true) == 0)
		{
			SetPlayerPos(playerid, 1207.0831, 3652.5256, 11.0660);
			SetPlayerFacingAngle(playerid, 0.0);
		}
		else if(strcmp(camerapos,"9",true) == 0)
		{
		    SetPlayerPos(playerid, 1317.4996, 1255.2955, 20.3359);
			SetPlayerFacingAngle(playerid, 180.0);
		}
		else if(strcmp(camerapos,"10",true) == 0)
		{
		    SetPlayerPos(playerid, 2294.0789, 526.9529, 1.7944);
			SetPlayerFacingAngle(playerid, 0.0);
		}
		else if(strcmp(camerapos,"11",true) == 0)
		{
		    SetPlayerInterior(playerid, 3);
		    SetPlayerPos(playerid, 189.5592, 178.1482, 1003.0234);
			SetPlayerFacingAngle(playerid, 0.0);
		}
		else if(strcmp(camerapos,"12",true) == 0)
		{
		    SetPlayerInterior(playerid, 0);
		    SetPlayerPos(playerid, 1757.0880, 2079.6694, 10.8203);
			SetPlayerFacingAngle(playerid, 180.0);
		}
		else if(strcmp(camerapos,"13",true) == 0)
		{
			SetPlayerPos(playerid, 1625.3883, 1831.7507, 10.8203);
			SetPlayerFacingAngle(playerid, 310.0);
		}
		else if(strcmp(camerapos,"14",true) == 0)
		{
			SetPlayerPos(playerid, 2002.1588, 2297.0879, 10.8203);
			SetPlayerFacingAngle(playerid, 180.0);
		}
		else if(strcmp(camerapos,"15",true) == 0)
		{
		    SetPlayerPos(playerid, 2083.4900, 2221.1001, 10.8203);
			SetPlayerFacingAngle(playerid, 180.0);
		}
		else if(strcmp(camerapos,"16",true) == 0)
		{
		    SetPlayerPos(playerid, 1153.1208, 1403.4666, 5.8203);
			SetPlayerFacingAngle(playerid, 90.0);
		}
		else if(strcmp(camerapos,"17",true) == 0)
		{
     		SetPlayerPos(playerid, 1457.3098, 1580.2455, 10.8130);
	 		SetPlayerFacingAngle(playerid, 270.0);
		}
		else if(strcmp(camerapos,"18",true) == 0)
		{
		    SetPlayerPos(playerid, 2175.5911, 1285.7224, 42.2241);
			SetPlayerFacingAngle(playerid, 90.0);
		}
		else
		{
	...
	if(!strcmp(cmdtext, "/spawnclone", true))
	{
	    new
		    Clone,
			outcome,
	    ...
	    switch(outcome)
	    {
	        case 0:
	        {
				...
				Clone = CreateDynamicObject(3092, X, Y, Z, 0, 0, 0);
			}
			case 1:
			{
			    DestroyDynamicObject(Clone);
		    	SetPlayerPos(playerid, X, Y-3, Z);
			}
		}
		return 1;
